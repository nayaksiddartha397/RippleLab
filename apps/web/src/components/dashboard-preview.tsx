      ...
      <section className="dashboard-grid">
        <Card className="scenario-card" elevated>
          ...
          <div className="scenario-live-card">
            ...
            <ul>
              <li>Income-tax scenarios compare official slabs with editable marginal-rate shifts.</li>
            ...
            <div className="scenario-live-actions">
              <Link className="button button--primary button--md" href={profile ? "/scenarios/income-tax" : "/profile"}>
                {profile ? "Model income tax" : "Create profile first"} <Icon name="arrow" />
              </Link>
              {profile ? <Link className="button button--secondary button--md" href="/scenarios/oil-price">Model oil prices</Link> : null}
            </div>
          </div>
        </Card>
        ...
        <Card className="causal-preview">
          ...
          />
          <div aria-label="Illustrative income-tax causal path" className="causal-path" role="img">
            <span>Annual income</span>
            <Icon name="chevron" />
            <span>Taxable income</span>
            <Icon name="chevron" />
            <span>Current vs proposed tax</span>
            <Icon name="chevron" />
            <span className="causal-path__highlight">Take-home impact</span>
          </div>
          <p>
